    ...
    <header>
        ...
        <ul class="side-nav"  id="mobile-demo">
                ...
                <div class="card z-depth-0" style="height: 90px; background: rgba(0, 0, 0, 0.8); min-height: 80px; width: 320px;">
                    ...
                    <p class="center" style="font-size: bold; ">{{Auth::user()->nombre_completo}}</p>
                    <p class="center" style="font-size: bold; ">{{Auth::user()->rol->desc}}</p>
        ...
        <div style="top: 500px">
        @if(Auth::user()->rol->desc == 'Vendedor')
            <li>
                <a href="/home" class="collapsible-header waves-effect waves-teal active">
                <i class="material-icons light">home</i>Inicio
                </a>
            </li>

            <li>
                <a href="{{route('ventas')}}" class="collapsible-header waves-effect waves-teal active">
                <i class="material-icons light">add_shopping_cart</i>Venta
                </a>
            </li>
        @else
        <li>
                <a href="/supervisor/estadisticas" class="collapsible-header waves-effect waves-teal active">
                <i class="material-icons light">trending_up</i>Estadísticas
                </a>
            </li>
        @endif
                ...
                <li>
                    <a href="{{ route('logout') }}" class="collapsible-header waves-effect waves-teal active"
                        ...
                        <i class="material-icons light">highlight_off</i>Cerrar sesion
                    </a>
